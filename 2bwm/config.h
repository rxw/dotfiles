 ...
 *6)emptycol         */
static const char *colors[] = {"#D9E313","#333333","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
/*
...
static key keys[] = {
    ...
    {  MOD ,              XK_Right,      nextworkspace,     {.i=0}},
    {  MOD ,              XK_Left,       prevworkspace,     {.i=0}},
    // Move to Next/Previous workspace
    {  MOD |SHIFT ,       XK_Right,      sendtonextworkspace,{.i=0}},
    {  MOD |SHIFT ,       XK_Left,       sendtoprevworkspace,{.i=0}},
    // Iconify the window
    {  MOD ,              XK_i,          hide,              {.i=0}},
